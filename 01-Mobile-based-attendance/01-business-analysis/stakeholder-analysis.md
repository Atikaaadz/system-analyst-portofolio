...
| Stakeholder | Role |
|---|---|
| Admin | Mengelola sistem dan data kehadiran |
| Participant | Melakukan Presensi dan akses informasi kehadiran|
...
- Logout untuk mengakhiri sesi.
- Akses terhadap jadwal kegiatan.
- Kemampuan melakukan presensi.
- Kemampuan memvalidasi lokasi pengguna.
